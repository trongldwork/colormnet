...
def main():
    ...
    parser.add_argument("--cdc", action="store_true", help="Calculate CDC.")
    ...
    parser.add_argument("--colorfulness", action="store_true", help="Calculate Colorfulness.")

    args = parser.parse_args()

    flag_CalFid = args.fid
    flag_CalCDC = args.cdc
    flag_CalPSNR = args.psnr
    flag_CalSSIM = args.ssim
    flag_CalLPIPS = args.lpips
    flag_CalColorfulness = args.colorfulness
    
    GT_dataset_folder = args.gt_folder
    real_save_folder = args.result_folder
